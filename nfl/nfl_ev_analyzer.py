...
class NFLEVAnalyzer(BaseAnalyzer):
    """NFL EV+ Singles prediction analyzer using Claude AI.

    Analyzes NFL EV+ Singles predictions against actual results to determine:
