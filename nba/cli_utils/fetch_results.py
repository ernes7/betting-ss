...
def fetch_results():
    """Fetch results for all NBA games on a specific date.
    ...
    5. Confirm with user
    6. Use ResultsFetcher to fetch results from Basketball-Reference
    7. Save results to nba/results/{date}/{game}.json
    ...
    console.print(Panel(
        ...
        f"[dim]This feature will fetch game results from Basketball-Reference\n"
        f"and save them to nba/results/{target_date}/[/dim]",
