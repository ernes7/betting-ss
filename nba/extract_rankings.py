"""NBA Rankings Extraction Tool

Extracts all ranking tables from Basketball-Reference.com and converts to JSON.
"""
...
def extract_all_rankings(url: str = NBA_STATS_URL, output_dir: str = DATA_RANKINGS_DIR) -> dict:
    """
