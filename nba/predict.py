...
from nba.prompt import build_prediction_prompt
...
def load_ranking_tables() -> dict[str, dict]:
    """Load all ranking tables from nba/data/rankings/."""
    rankings_dir = Path("nba/data/rankings")
    rankings = {}

    if not rankings_dir.exists():
        print("Warning: nba/data/rankings/ folder not found")
        return rankings
