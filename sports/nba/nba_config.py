...
from sports.nba.prompt_components import NBAPromptComponents
...
class NBAConfig(SportConfig):
    ...
    def predictions_dir(self) -> str:
        return "sports/nba/data/predictions"

    @property
    def results_dir(self) -> str:
        return "sports/nba/data/results"

    @property
    def analysis_dir(self) -> str:
        return "sports/nba/data/analysis"
