...
class TableExtractor:
    ...
    Example:
        with scraper.launch() as page:
            ...
            table_data = TableExtractor.extract(page, "player_stats")
    """
    ...
    def _get_logger(cls):
        ...
        if cls._logger is None:
            cls._logger = LoggerFactory.get_logger("scraping")
        return cls._logger
    ...
    def extract(page: Page, table_id: str) -> dict | None:
        ...
        try:
            ...
            TableExtractor._get_logger().error(f"Error extracting table '{table_id}': {str(e)}")
            return None

    @staticmethod
    def extract_multiple(page: Page, table_ids: list[str]) -> dict[str, dict]:
        """Extract multiple tables from the page.
        ...
        Returns:
            Dictionary mapping table_id to extracted table data
        """
        results = {}
